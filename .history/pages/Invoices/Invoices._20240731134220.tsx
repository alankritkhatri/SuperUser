...
const Invoices = () => {
  ...
  const [companyCountry, setIdesc] = useState("");
  const [companyCountry, setQty] = useState("");
  const [companyCountry, setrate] = useState("");
  const [companyCountry, setAmount] = useState("");
