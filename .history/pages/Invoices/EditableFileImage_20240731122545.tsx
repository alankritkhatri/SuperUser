...
const EditableFileImage: FC<Props> = ({
  ...
  return (
    ...
    >
      {!value ? (
        <button type="button" className="image__upload" onClick={}>
          {placeholder}
        </button>
      ) : (
        <>
          ...
          <button type="button" className="image__change" onClick={}>
            Change Image
          </button>
          ...
          {isEditing && (
            <div ref={widthWrapper} className="image__width-wrapper"></div>
          )}
        </>
      )}
